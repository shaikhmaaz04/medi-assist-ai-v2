...
if __name__ == "__main__":
    ...
    # 2. Search for Intermittent Fasting studies
    term = "Intermittent Fasting AND Diabetes"
    print(f"Searching for: {term}...")
    ids = scraper.search_pubmed_articles(term, max_results=5)
    
    # 3. Fetch the actual content
    results = scraper.fetch_pubmed_abstracts(ids)
